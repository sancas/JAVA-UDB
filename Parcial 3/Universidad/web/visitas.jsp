...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <c:if test="${isDirector == false}"><c:redirect url="visita.jsp"></c:redirect></c:if>
            <body>
                <!--[if lt IE 8]>
        ...
        <div class="jumbotron">
            <div class="container">
                <div class="row">
                    <h1>Visitas</h1>
                    <p>Aqui podra administrar las visitas de los docentes.</p>
                        ...
                        <div class="panel panel-default panel-table">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <button type="button" class="btn btn-sm btn-primary btn-create" data-toggle="modal" data-target="#AddVisit">Agregar Visita</button>
                                    </div>
                                    <!-- Modal -->
                                    <div class="modal fade" id="AddVisit" tabindex="-1" role="dialog" aria-labelledby="AddVisit" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <form id='addVisit' role='form'>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                                                                ...
                                                                <hr class="colorgraph">
                                                                <div class="form-group">
                                                                    <select name='escuela' id="escuela" class="form-control input-lg" placeholder="Seleccione una escuela" tabindex="1" required>
                                                                        <%@include file="fillSchoolSelect.jsp" %>
                                                                    </select>
                                                                </div>
                                                                    <div class="form-group">
                                                                    <select name='docente' id="docente" class="form-control input-lg" placeholder="Seleccione un docente" tabindex="2" required>
                                                                    </select>
                                                                </div>
                                                                    <div class="form-group">
                                                                    <input type="text" name="institution" id="institution" class="form-control input-lg" placeholder="Institucion" tabindex="3" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="date" name="date" id="date" class="form-control input-lg" placeholder="Fecha" tabindex="4" required>
                                                                </div>
                                                                <hr class="colorgraph">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" id='cerrarInsertarVisit' class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered table-list">
                                    ...
                                    <tbody>
                                        <%@include file="fillVisitTable.jsp" %>
                                    </tbody>
                                </table>
